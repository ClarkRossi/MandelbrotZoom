...
public class mandZoom 
{
	...
	public static void main (String args[]) throws Exception, IOException
	{
		...
		//Zoom points
		double ZOOM_X = 0.7917365619, ZOOM_Y = 0.1519467822;
		//double ZOOM_X = -0.8313863693, ZOOM_Y = -0.2291812104;
		//double ZOOM_X = 0.2593110766, ZOOM_Y = -0.001461608912;

		//Value should be increased for deeper zooms		
		int MAX_ITER = 4500;

		//Video length and zoom speed variables
		int TOTAL_FRAMES = 1800;	//Total length of video, 60 = 1sec
		...
		{		
			...
			if(((((double)i/(double)TOTAL_FRAMES)*10)/3) > ZOOM_MIN);
				POW_VAL = (((double)i/(double)TOTAL_FRAMES)*10)/3;
			...
			for (y = 0; y < HEIGHT; y++) 
			{
				...
				{	
					...
					Mand M = new Mand(x, y, MAX_ITER, cX, cY);
					rgb = M.pixelColor();
